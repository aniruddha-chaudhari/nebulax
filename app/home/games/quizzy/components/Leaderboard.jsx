...
const Leaderboard = ({ onBack }) => {
  ...
  const getRankStyle = (index) => {
    if (index === 0) return { color: '#FFD700', textShadow: '0 0 5px rgba(255, 215, 0, 0.7)' };
    if (index === 1) return { color: '#C0C0C0', textShadow: '0 0 5px rgba(192, 192, 192, 0.7)' };
    if (index === 2) return { color: '#CD7F32', textShadow: '0 0 5px rgba(205, 127, 50, 0.7)' };
    return {};
  };
